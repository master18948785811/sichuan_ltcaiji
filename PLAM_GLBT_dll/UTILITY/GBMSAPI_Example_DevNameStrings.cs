...
namespace GBMSAPI_CS_Example.UTILITY
{
    ...
    {
        public
            static String ScannerSurfaceNotNormalDiagMessString = "手指放得太前或采集仪镜面有污物";
        public
            static String ScannerFailureDiagMessString = "采集图像的参数不符合质量标准";
        public
            static String CompositionSlowDiagMessString = "帧率过慢，不能保证滚动指纹的正确构图";
        public
            static String FlatFingerSlidingDiagMessString = "平面指纹滑动";
        public
            static String ExternalLightDiagMessString = "外部光太强";
        public
            static String FingerOutOfRegionLeftDiagMessString = "手指超出左边的边界";
        public
            static String FingerOutOfRegionRightDiagMessString = "手指超出右边的边界";
        public
            static String FingerOutOfRegionTopDiagMessString = "手指超出上边的边界";
        public
            static String FingerDisplacedDownDiagMessString = "手指明显位移到下界";
        public
            static String ImproperRollDiagMessString = "手指滚动不当";
        public
            static String TooFastRollDiagMessString = "手指滚动过快";
        public
            static String TooNarrowRollDiagMessString = "手指滚动区域过窄";
        public static String RollDirLeftDiagMessString = "手指向左滚动";
        public static String RollDirRightDiagMessString = "手指向右滚动";

        public static String DryFingerDiagMessString = "警告: 手指太干";

        public static String WetFingerDiagMessString = "警告: 手指太湿";

        public static String TooShortVerticalRollDiagMessString = "手指在垂直方向上滚动得太快了";

        public static String RollDirUpDiagMessString = "向上滚动手指";
        public static String RollDirDownDiagMessString = "向下滚动手指";

        public static String AutoCaptureBlockedForFakeFingerDetectionString = "伪手指检测：抬起手指并重试";
    }
